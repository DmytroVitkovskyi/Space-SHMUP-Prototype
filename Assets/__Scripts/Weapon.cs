...
/// Аббревиатурой [НР] ниже отмечены элементы, не реализованные в этой книге.
/// </summary>
public enum WeaponType
{
    ...
    laser, // [НР] Наносит повреждения при долговременном воздействии
...
public class WeaponDefinition
{
    ...
    public float damageOnHit = 0; // Сила атаки
    public float continuousDamage = 0; // Сила атаки в секунду (для Laser)
